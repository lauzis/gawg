...
- **Admin UI** — a dedicated GAWG menu in the WordPress admin with:
  ...
  - **Giveaways** — list and manage all giveaway taxonomy terms. Each term's edit screen shows a read-only **Winner** field once a winner has been drawn, and a **Closed for Participants** checkbox to manually open or close the giveaway. The list table includes a sortable **Status** column (Active / Closed / Winner Drawn).
