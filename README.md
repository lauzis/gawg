...
- **Admin UI** — a dedicated GAWG menu in the WordPress admin with:
  ...
  - **Self Tests** page — run built-in verification checks (e.g. UUID generation, email verification logic) directly from the admin panel.
